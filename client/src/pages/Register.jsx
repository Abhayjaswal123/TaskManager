...
import { User, Mail, Lock, ArrowRight, AlertCircle } from "../components/icons";
        ...
        <div className="min-h-screen flex items-center justify-center bg-[#050818] relative overflow-hidden px-4">
            ...
            <div className="relative w-full max-w-sm z-10">
                ...
                <div className="p-7 rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-xl
                    ...
                    <p className="text-[#4a5a72] text-sm mb-6">Start managing your tasks today</p>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        ...
                        {/* Name */}
                        <div>
                            <label className="text-xs font-medium text-[#7a8ba6] mb-1.5 block">Full Name</label>
                            <div className="relative">
                                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#4a5a72]" />
                                <input
                                    type="text"
                                    name="name"
                                    value={form.name}
